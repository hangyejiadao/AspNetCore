...
namespace Dos.ORM.IData.Business
{
    ...
    /// 
    /// </summary>
    public interface IBUS_LaboratoryData : IDBBase<BUS_Laboratory>
    {
        /// <summary>
        /// 获取实验室列表
        /// </summary>
        ...
        OperateModel AddModelList(IList<BUS_Laboratory> modelList, Guid projectId, string timeStamp);
    }
}
