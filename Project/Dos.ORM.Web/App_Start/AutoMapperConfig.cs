...
namespace Dos.ORM.Web
{
    ...
    public static class AutoMapperConfig
    {
        public static void InitConfig()
        {
            ...
            //BUS_Module to ZTreeModel
            AutoMapperHelper.CreateMapTo<BUS_Module, ZTreeModel>()
                .ConstructUsing(s => new ZTreeModel
                {
                    id = s.ID,
                    pId = s.ParentID,
            ...
            //BUS_Project to ZTreeModel
            AutoMapperHelper.CreateMapTo<BUS_Project, ZTreeModel>()
                .ConstructUsing(s => new ZTreeModel
                {
                    id = s.ProjectID,
                    name = s.ProjectName,
            ...
            //BUS_Laboratory to ZTreeModel
            AutoMapperHelper.CreateMapTo<BUS_Laboratory, ZTreeModel>()
                .ConstructUsing(s => new ZTreeModel
                {
                    id = s.OrganID,
                    name = s.OrganName,
