...
namespace Dos.ORM.Web.Controllers.Base
{
    ...
    public class BaseController : Controller
    {
        ...
        /// <returns></returns>
        protected JsonResult QbJson(object data, string format = "yyyy-MM-dd HH:mm:ss")
        {
            return new JsonResultOverride
            {
                Data = data,
        ...
        /// <param name="format">时间格式化格式（默认为yyyy-MM-dd HH:mm:ss）</param>
        /// <returns></returns>
        protected JsonResult QbJson(object data, JsonRequestBehavior behavior, string format = "yyyy-MM-dd HH:mm:ss")
        {
            return new JsonResultOverride
            {
                Data = data,
