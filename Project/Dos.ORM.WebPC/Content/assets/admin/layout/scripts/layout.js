...
var Layout = function () {
    ...
    var handleSidebarToggler = function () {
        ...
        if (body.hasClass("page-sidebar-closed")) {
            $(".page-sidebar-menu .sub-menu").removeClass("menubar-scrolling");
        }
        else {
            $(".page-sidebar-menu .sub-menu").addClass("menubar-scrolling");
        }
        ...
        $('body').on('click', '.sidebar-toggler', function (e) {
            ...
            var sidebarSubMenu = $(".page-sidebar-menu .sub-menu");
            $(".sidebar-search", sidebar).removeClass("open");

            if (body.hasClass("page-sidebar-closed")) {
                body.removeClass("page-sidebar-closed");
                sidebarMenu.removeClass("page-sidebar-menu-closed");
                sidebarSubMenu.addClass("menubar-scrolling");
                if ($.cookie) {
                ...
                sidebarSubMenu.removeClass("menubar-scrolling");
                if (body.hasClass("page-sidebar-fixed")) {
    ...
    var handleTogglerSidebar = function (expand) {
    ...
    return {
        ...
        setSidebarToggler: function (expand) {
            handleTogglerSidebar(expand);
        },
