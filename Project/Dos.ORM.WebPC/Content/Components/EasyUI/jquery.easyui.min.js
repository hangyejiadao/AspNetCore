...
/*
quber：
    增加"sum","sumCol", "avg","avgCol", "max","maxCol", "min","minCol"扩展统计
*/
var col=$.extend({},$.parser.parseOptions(this,["sum", "sumCol", "avg", "avgCol", "max", "maxCol", "min", "minCol", "id","field","align","halign","order","width",{sortable:"boolean",checkbox:"boolean",resizable:"boolean",fixed:"boolean"},{rowspan:"number",colspan:"number"}]),{title:(th.html()||undefined),hidden:(th.attr("hidden")?true:undefined),formatter:(th.attr("formatter")?eval(th.attr("formatter")):undefined),styler:(th.attr("styler")?eval(th.attr("styler")):undefined),sorter:(th.attr("sorter")?eval(th.attr("sorter")):undefined)});
...
if(_683&&opts.rownumbers){
    var td = $("<td rowspan=\"" + opts.frozenColumns.length + "\"><div class=\"datagrid-header-rownumber\"><span title=\"点击显示列\"  onclick=\"onHeaderColumnsMenu(this)\" class=\"fa fa-th datagrid-header-rownumber_icon \"></span></div></td>");
if($("tr",t).length==0){
...
/*
quber：
    panelHeight:200→panelHeight:'auto'
*/
$.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_9fe,keydown:_a02,paste:_a02,drop:_a02},panelWidth:null,panelHeight:'auto',panelMinWidth:null,panelMaxWidth:null,panelMinHeight:null,panelMaxHeight:null,panelAlign:"left",multiple:false,selectOnNavigation:true,separator:",",hasDownArrow:true,delay:200,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
...
if(_af8&&typeof _af8=="object" && _af8 != null){//quber：此处增加条件&&_af8!=null，防止数据为null时输出错误
