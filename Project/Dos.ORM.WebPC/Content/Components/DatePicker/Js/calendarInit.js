...
var $dp, WdatePicker; (function () {
    var $ = {
        ...
        $preLoad: false,
        //配置插件安装包的绝对路径
        $dpPath: "/Content/Components/DatePicker/",
        ...
        readOnly: false,
        errDealMode: 0,
        autoPickDate: null,//default value is null [true,false,null]
        qsEnabled: true,
        autoShowQS: false,
        opposite: false,
...
var dateChoose = {
    format: [
        ...
        { dateFmt: 'HH:mm:ss' },
        { dateFmt: 'DD, MMMM d, yyyy' },
        { dateFmt: 'yyyy-MM-dd', doubleCalendar: true },
        { maxDate: '%y-%M-%d' },
        { minDate: '%y-%M-{%d+1}' },
        { minDate: '%y-%M-01', maxDate: '%y-%M-%ld' },
        { dateFmt: 'yyyy-M-d H:mm:ss', minDate: '%y-%M-%d 7:00:00', maxDate: '%y-%M-{%d+1} 21:00:00' },
        { minDate: '2013-06-06', maxDate: '2013-11-11' },
        { dateFmt: 'yyyy-MM-dd HH:mm:ss', minDate: '2013-11-27 06:30:00', maxDate: '2013-11-28 12:30:30' },
        { dateFmt: 'yyyy年MM月', minDate: '2013-10', maxDate: '2013-12' },
        { dateFmt: 'HH:mm:ss', minDate: '06:30:00', maxDate: '12:30:30' },
        { disabledDays: [0, 6] },
        { specialDays: [1, 5] },
        { specialDates: ['....-..-01', '....-..-15', '....-..-25'] },
        { minDate: '%y-%M-{%d}' },
        { dateFmt: 'yyyy' },
        { dateFmt: 'yyyy-MM' }
    ],
    click: function (index) { WdatePicker(this.format[index]); }
};