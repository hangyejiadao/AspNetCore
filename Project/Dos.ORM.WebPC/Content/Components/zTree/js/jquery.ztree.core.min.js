...
a.isAjaxing||(c[0]=(a.iconSkin?a.iconSkin+"_":"")+c[0],a.isParent?c.push(a.open?f.folder.OPEN:f.folder.CLOSE):c.push(f.folder.DOCU));return f.className.BUTTON+" "+c.join("_")},makeNodeIcoStyle:function(b,a){var c=[];if(!a.isAjaxing){var d=a.isParent&&a.iconOpen&&a.iconClose?a.open?a.iconOpen:a.iconClose:a[b.data.key.icon];d&&c.push("background:url(",d,") center 4px no-repeat;");(b.view.showIcon==!1||!j.apply(b.view.showIcon,[b.treeId,a],!0))&&c.push("width:0px;height:0px;")}return c.join("")},makeNodeLineClass:function(b,
...
********************************************/
(function () {
    var _thisScript, _thisPath, _thisSkin;
    _thisPath = window['FilePath'] || (function (script, i, me) {
        for (i in script) {
            if (script[i].src && script[i].src.indexOf('ztree') !== -1) me = script[i];
        };
        _thisScript = me || script[script.length - 1];
        me = _thisScript.src.replace(/\\/g, '/');
        return me.lastIndexOf('/') < 0 ? '.' : me.substring(0, me.lastIndexOf('/'));
    }(document.getElementsByTagName('script')));
    //_thisPath = _thisPath.replace("/Js", "");
    //console.log(_thisPath)
    _thisSkin = _thisScript.src.split('skin=')[1];
    _thisSkin = _thisSkin == undefined || _thisSkin.length == 0 ? '_20x20' : _thisSkin == 16 ? '_16x16' : '_20x20';
    if (_thisSkin) {
        var link = document.createElement('link');
        link.rel = 'stylesheet';
        link.href = _thisPath.replace('/js', '/css/zTreeStyle/zTreeStyle.css');
